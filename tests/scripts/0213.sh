...
if [ $# == 0 ]; then
	echo "Conventional file seq write (aggr_cnv, direct)"
        exit 0
fi
...
echo "Check conventional file seq write, aggr_cnv, direct (sync)"
...
echo "Check conventional file seq write, aggr_cnv, direct (async)"
